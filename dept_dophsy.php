...
<body class="mt-4">
  ...
  <?php 
    $faculty = "Faculty of Social and Basic Science";
      ...
      <div class="row">
        ...
        <div class="col-12">
          ...
          <div class="tabbed-interface">
            <ul class="tabs">
              <li><a href="#program1" class="active">BS(PH)</a></li>
            ...
            <div class="tab-content active" id="program1">
              ...
              <?php include "program_bsph_$semester.php"; ?>
            </div>
            ...
            <div class="tab-content" id="program3">
              ...
              <?php include "program_mba35_$semester"; ?>
            </div>
