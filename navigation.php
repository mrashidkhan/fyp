    ...
    <header>
        <div class="container text-center">
            <div class="row">
                ...
                <div class="col-12 col-md-8 mt-2 heading-container">
                    <h3 style="color:#112269">Mohammad Ali Jinnah University</h3>
                    <h4 style="color: #D62C1F"><?php echo $faculty; ?></h4>
                    <h5 style="color:#112269"><?php echo $department; ?></h5>
                    <h6 style="color:#D62C1F">Final Year Projects </h6>
                    <!-- <?php echo $term; ?> -->
                </div>
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="dept_soba_sp21.php">SCHOOL OF BUSINESS ADMINISTRATION SP21
                                PROJECTS</a></li>
