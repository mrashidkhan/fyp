            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="tabbed-interface">
                        <ul class="tabs">
                            <li><a href="#program1" class="active" >BSCS</a></li>
                            <li><a href="#program2">MCS</a></li>
                            
                        </ul>
                        <div class="tab-content active" id="program1">
                            <!-- Display projects for Program 1 -->
                            <?php include 'program_bscs_sp22.php'; ?>
                        </div>
                        <div class="tab-content" id="program2">
                            <!-- Display projects for Program 2 -->
                            <?php include 'program_mcs_sp22.php'; ?>
                        </div>
...
<script>
  ...
  tabs.forEach(tab => {
    tab.addEventListener('click', e => {
      ...
      tabContent.forEach(content => content.classList.remove('active')); // Remove active class from all tab contents
